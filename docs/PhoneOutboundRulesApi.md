# CircuitIDAPIClient::PhoneOutboundRulesApi
...
api_instance = CircuitIDAPIClient::PhoneOutboundRulesApi.new
phoneoutboundrules = CircuitIDAPIClient::Phoneoutboundrules.new({name: 3.56}) # Phoneoutboundrules | The JSON object that will be posted to the REST API endpoint.
...
api_instance = CircuitIDAPIClient::PhoneOutboundRulesApi.new
id = TODO # Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
phoneoutboundrules = CircuitIDAPIClient::Phoneoutboundrules.new({name: 3.56}) # Phoneoutboundrules | The request data.
