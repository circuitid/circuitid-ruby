...
developerappsubscriptions = CircuitID::Developerappsubscriptions.new({developer_app: 3.56, services: 3.56}) # Developerappsubscriptions | The JSON object that will be posted to the REST API endpoint.
...
api_instance = CircuitID::DeveloperAppSubscriptionsApi.new
id = TODO # Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
developerappsubscriptions = CircuitID::Developerappsubscriptions.new({developer_app: 3.56, services: 3.56}) # Developerappsubscriptions | The request data.
