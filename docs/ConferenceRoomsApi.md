# CircuitIDAPIClient::ConferenceRoomsApi
...
> Object create_conference_room(conferencerooms)
...
api_instance = CircuitIDAPIClient::ConferenceRoomsApi.new
conferencerooms = CircuitIDAPIClient::Conferencerooms.new({name: 3.56}) # Conferencerooms | The JSON object that will be posted to the REST API endpoint.

begin
  # Create a new object
  result = api_instance.create_conference_room(conferencerooms)
  p result
...
> <Array(Object, Integer, Hash)> create_conference_room_with_http_info(conferencerooms)

```ruby
begin
  # Create a new object
  data, status_code, headers = api_instance.create_conference_room_with_http_info(conferencerooms)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => Object
rescue CircuitIDAPIClient::ApiError => e
...
> <Array(Object, Integer, Hash)> get_conference_room_with_http_info(id)
...
> Object patch_conference_room(id, conferencerooms)
...
api_instance = CircuitIDAPIClient::ConferenceRoomsApi.new
id = TODO # Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
conferencerooms = CircuitIDAPIClient::Conferencerooms.new({name: 3.56}) # Conferencerooms | The request data.

begin
  # Patch object's data
  result = api_instance.patch_conference_room(id, conferencerooms)
  p result
rescue CircuitIDAPIClient::ApiError => e
...
> <Array(Object, Integer, Hash)> patch_conference_room_with_http_info(id, conferencerooms)

```ruby
begin
  # Patch object's data
  data, status_code, headers = api_instance.patch_conference_room_with_http_info(id, conferencerooms)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => Object
rescue CircuitIDAPIClient::ApiError => e
...
> Object remove_conference_room(id)
...
> <Array(Object, Integer, Hash)> remove_conference_room_with_http_info(id)
