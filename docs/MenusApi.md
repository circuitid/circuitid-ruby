...
api_instance = CircuitIDAPIClient::MenusApi.new
menus = CircuitIDAPIClient::Menus.new({name: 3.56, max_extension_length: 3.56, greeting_type: tts}) # Menus | The JSON object that will be posted to the REST API endpoint.
...
> <Array(Object, Integer, Hash)> create_menu_with_http_info(menus)
...
> <Array(Object, Integer, Hash)> get_menu_with_http_info(id)
...
api_instance = CircuitIDAPIClient::MenusApi.new
id = TODO # Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
menus = CircuitIDAPIClient::Menus.new({name: 3.56, max_extension_length: 3.56, greeting_type: tts}) # Menus | The request data.
...
> <Array(Object, Integer, Hash)> patch_menu_with_http_info(id, menus)
...
> <Array(Object, Integer, Hash)> remove_menu_with_http_info(id)
