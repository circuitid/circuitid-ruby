...
menus = CircuitID::Menus.new({name: 3.56, max_extension_length: 3.56, greeting_type: tts}) # Menus | The JSON object that will be posted to the REST API endpoint.
...
api_instance = CircuitID::MenusApi.new
id = TODO # Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
menus = CircuitID::Menus.new({name: 3.56, max_extension_length: 3.56, greeting_type: tts}) # Menus | The request data.
