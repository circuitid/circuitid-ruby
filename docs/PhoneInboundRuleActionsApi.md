# CircuitIDAPIClient::PhoneInboundRuleActionsApi
...
> Object create_phone_inbound_rule_action(phoneinboundruleactions)
...
api_instance = CircuitIDAPIClient::PhoneInboundRuleActionsApi.new
phoneinboundruleactions = CircuitIDAPIClient::Phoneinboundruleactions.new({name: 3.56, phoneinboundrule: 3.56, priority: 3.56, destination_type: announcements}) # Phoneinboundruleactions | The JSON object that will be posted to the REST API endpoint.
...
> <Array(Object, Integer, Hash)> create_phone_inbound_rule_action_with_http_info(phoneinboundruleactions)
...
> Object get_phone_inbound_rule_action(id)
...
> <Array(Object, Integer, Hash)> get_phone_inbound_rule_action_with_http_info(id)
...
> Object patch_phone_inbound_rule_action(id, phoneinboundruleactions)
...
api_instance = CircuitIDAPIClient::PhoneInboundRuleActionsApi.new
id = TODO # Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
phoneinboundruleactions = CircuitIDAPIClient::Phoneinboundruleactions.new({name: 3.56, phoneinboundrule: 3.56, priority: 3.56, destination_type: announcements}) # Phoneinboundruleactions | The request data.
...
> <Array(Object, Integer, Hash)> patch_phone_inbound_rule_action_with_http_info(id, phoneinboundruleactions)
...
> Object remove_phone_inbound_rule_action(id)
...
> <Array(Object, Integer, Hash)> remove_phone_inbound_rule_action_with_http_info(id)
