...
phoneinboundruleactions = CircuitID::Phoneinboundruleactions.new({name: 3.56, phoneinboundrule: 3.56, priority: 3.56, destination_type: announcements}) # Phoneinboundruleactions | The JSON object that will be posted to the REST API endpoint.
...
api_instance = CircuitID::PhoneInboundRuleActionsApi.new
id = TODO # Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
phoneinboundruleactions = CircuitID::Phoneinboundruleactions.new({name: 3.56, phoneinboundrule: 3.56, priority: 3.56, destination_type: announcements}) # Phoneinboundruleactions | The request data.
