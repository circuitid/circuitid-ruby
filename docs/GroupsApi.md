...
api_instance = CircuitIDAPIClient::GroupsApi.new
groups = CircuitIDAPIClient::Groups.new({name: 3.56}) # Groups | The JSON object that will be posted to the REST API endpoint.
...
> <Array(Object, Integer, Hash)> create_group_with_http_info(groups)
...
> <Array(Object, Integer, Hash)> get_group_with_http_info(id)
...
api_instance = CircuitIDAPIClient::GroupsApi.new
id = TODO # Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
groups = CircuitIDAPIClient::Groups.new({name: 3.56}) # Groups | The request data.
...
> <Array(Object, Integer, Hash)> patch_group_with_http_info(id, groups)
...
> <Array(Object, Integer, Hash)> remove_group_with_http_info(id)
