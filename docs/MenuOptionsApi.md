...
menuoptions = CircuitID::Menuoptions.new({name: 3.56, digit: 3.56, menus: 3.56, destination_type: announcements}) # Menuoptions | The JSON object that will be posted to the REST API endpoint.
...
api_instance = CircuitID::MenuOptionsApi.new
id = TODO # Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
menuoptions = CircuitID::Menuoptions.new({name: 3.56, digit: 3.56, menus: 3.56, destination_type: announcements}) # Menuoptions | The request data.
