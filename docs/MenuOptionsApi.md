# CircuitIDAPIClient::MenuOptionsApi
...
> Object create_menu_option(menuoptions)
...
api_instance = CircuitIDAPIClient::MenuOptionsApi.new
menuoptions = CircuitIDAPIClient::Menuoptions.new({name: 3.56, digit: 3.56, menus: 3.56, destination_type: announcements}) # Menuoptions | The JSON object that will be posted to the REST API endpoint.
...
> <Array(Object, Integer, Hash)> create_menu_option_with_http_info(menuoptions)
...
> <Array(Object, Integer, Hash)> get_menu_option_with_http_info(id)
...
> Object patch_menu_option(id, menuoptions)
...
api_instance = CircuitIDAPIClient::MenuOptionsApi.new
id = TODO # Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
menuoptions = CircuitIDAPIClient::Menuoptions.new({name: 3.56, digit: 3.56, menus: 3.56, destination_type: announcements}) # Menuoptions | The request data.
...
> <Array(Object, Integer, Hash)> patch_menu_option_with_http_info(id, menuoptions)
...
> <Array(Object, Integer, Hash)> remove_menu_option_with_http_info(id)
