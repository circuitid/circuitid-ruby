...
> <GetAcceptedSender200Response> create_accepted_sender(acceptedsenders)
...
> <Array(<GetAcceptedSender200Response>, Integer, Hash)> create_accepted_sender_with_http_info(acceptedsenders)
...
> <GetAcceptedSender200Response> patch_accepted_sender(id, acceptedsenders)
...
api_instance = CircuitID::AcceptedSendersApi.new
id = 'id_example' # String | The ObjectId (unique 12 bytes ID) of record you would like to GET.
acceptedsenders = CircuitID::Acceptedsenders.new({object: 'object_example', service: 'service_example', service_ref: 'service_ref_example', ref: 'users'}) # Acceptedsenders | The request data.
...
> <Array(<GetAcceptedSender200Response>, Integer, Hash)> patch_accepted_sender_with_http_info(id, acceptedsenders)
