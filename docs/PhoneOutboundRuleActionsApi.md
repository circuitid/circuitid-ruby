# CircuitID::PhoneOutboundRuleActionsApi
...
phoneoutboundruleactions = CircuitID::Phoneoutboundruleactions.new({name: 3.56, phoneoutboundrule: 3.56, priority: 3.56, route: default}) # Phoneoutboundruleactions | The JSON object that will be posted to the REST API endpoint.
...
api_instance = CircuitID::PhoneOutboundRuleActionsApi.new
id = TODO # Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
phoneoutboundruleactions = CircuitID::Phoneoutboundruleactions.new({name: 3.56, phoneoutboundrule: 3.56, priority: 3.56, route: default}) # Phoneoutboundruleactions | The request data.
