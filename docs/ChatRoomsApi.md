# CircuitIDAPIClient::ChatRoomsApi
...
> Object create_chat_room(chatrooms)
...
api_instance = CircuitIDAPIClient::ChatRoomsApi.new
chatrooms = CircuitIDAPIClient::Chatrooms.new({users: 3.56}) # Chatrooms | The JSON object that will be posted to the REST API endpoint.

begin
  # Create a new object
  result = api_instance.create_chat_room(chatrooms)
  p result
...
> <Array(Object, Integer, Hash)> create_chat_room_with_http_info(chatrooms)

```ruby
begin
  # Create a new object
  data, status_code, headers = api_instance.create_chat_room_with_http_info(chatrooms)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => Object
rescue CircuitIDAPIClient::ApiError => e
...
> <Array(Object, Integer, Hash)> get_chat_room_with_http_info(id)
...
> Object patch_chat_room(id, chatrooms)
...
api_instance = CircuitIDAPIClient::ChatRoomsApi.new
id = TODO # Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
chatrooms = CircuitIDAPIClient::Chatrooms.new({users: 3.56}) # Chatrooms | The request data.

begin
  # Patch object's data
  result = api_instance.patch_chat_room(id, chatrooms)
  p result
rescue CircuitIDAPIClient::ApiError => e
...
> <Array(Object, Integer, Hash)> patch_chat_room_with_http_info(id, chatrooms)

```ruby
begin
  # Patch object's data
  data, status_code, headers = api_instance.patch_chat_room_with_http_info(id, chatrooms)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => Object
rescue CircuitIDAPIClient::ApiError => e
...
> <Array(Object, Integer, Hash)> remove_chat_room_with_http_info(id)
