...
timeschedules = CircuitID::Timeschedules.new({name: 3.56, timezone: Africa/Abidjan, sunday: 3.56, monday: 3.56, tuesday: 3.56, wednesday: 3.56, thursday: 3.56, friday: 3.56, saturday: 3.56}) # Timeschedules | The JSON object that will be posted to the REST API endpoint.
...
api_instance = CircuitID::TimeSchedulesApi.new
id = TODO # Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
timeschedules = CircuitID::Timeschedules.new({name: 3.56, timezone: Africa/Abidjan, sunday: 3.56, monday: 3.56, tuesday: 3.56, wednesday: 3.56, thursday: 3.56, friday: 3.56, saturday: 3.56}) # Timeschedules | The request data.
