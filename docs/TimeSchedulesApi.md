# CircuitIDAPIClient::TimeSchedulesApi
...
> Object create_time_schedule(timeschedules)
...
api_instance = CircuitIDAPIClient::TimeSchedulesApi.new
timeschedules = CircuitIDAPIClient::Timeschedules.new({name: 3.56, timezone: Africa/Abidjan, sunday: 3.56, monday: 3.56, tuesday: 3.56, wednesday: 3.56, thursday: 3.56, friday: 3.56, saturday: 3.56}) # Timeschedules | The JSON object that will be posted to the REST API endpoint.
...
> <Array(Object, Integer, Hash)> create_time_schedule_with_http_info(timeschedules)
...
> <Array(Object, Integer, Hash)> get_time_schedule_with_http_info(id)
...
> Object patch_time_schedule(id, timeschedules)
...
api_instance = CircuitIDAPIClient::TimeSchedulesApi.new
id = TODO # Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
timeschedules = CircuitIDAPIClient::Timeschedules.new({name: 3.56, timezone: Africa/Abidjan, sunday: 3.56, monday: 3.56, tuesday: 3.56, wednesday: 3.56, thursday: 3.56, friday: 3.56, saturday: 3.56}) # Timeschedules | The request data.
...
> <Array(Object, Integer, Hash)> patch_time_schedule_with_http_info(id, timeschedules)
...
> Object remove_time_schedule(id)
...
> <Array(Object, Integer, Hash)> remove_time_schedule_with_http_info(id)
