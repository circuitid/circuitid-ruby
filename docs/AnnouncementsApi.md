# CircuitIDAPIClient::AnnouncementsApi
...
api_instance = CircuitIDAPIClient::AnnouncementsApi.new
announcements = CircuitIDAPIClient::Announcements.new({name: 3.56, type: tts}) # Announcements | The JSON object that will be posted to the REST API endpoint.
...
api_instance = CircuitIDAPIClient::AnnouncementsApi.new
id = TODO # Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
announcements = CircuitIDAPIClient::Announcements.new({name: 3.56, type: tts}) # Announcements | The request data.
