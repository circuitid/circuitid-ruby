...
firewall = CircuitID::Firewall.new({name: 3.56, priority: 3.56, type: allow, target: numbers, param: 3.56}) # Firewall | The JSON object that will be posted to the REST API endpoint.
...
api_instance = CircuitID::FirewallApi.new
id = TODO # Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
firewall = CircuitID::Firewall.new({name: 3.56, priority: 3.56, type: allow, target: numbers, param: 3.56}) # Firewall | The request data.
