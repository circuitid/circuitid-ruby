# CircuitIDAPIClient::FirewallApi
...
> Object create_firewall(firewall)
...
api_instance = CircuitIDAPIClient::FirewallApi.new
firewall = CircuitIDAPIClient::Firewall.new({name: 3.56, priority: 3.56, type: allow, target: numbers, param: 3.56}) # Firewall | The JSON object that will be posted to the REST API endpoint.

begin
  # Create a new object
  result = api_instance.create_firewall(firewall)
  p result
...
> <Array(Object, Integer, Hash)> create_firewall_with_http_info(firewall)

```ruby
begin
  # Create a new object
  data, status_code, headers = api_instance.create_firewall_with_http_info(firewall)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => Object
rescue CircuitIDAPIClient::ApiError => e
...
> <Array(Object, Integer, Hash)> get_firewall_with_http_info(id)
...
> Object patch_firewall(id, firewall)
...
api_instance = CircuitIDAPIClient::FirewallApi.new
id = TODO # Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
firewall = CircuitIDAPIClient::Firewall.new({name: 3.56, priority: 3.56, type: allow, target: numbers, param: 3.56}) # Firewall | The request data.

begin
  # Patch object's data
  result = api_instance.patch_firewall(id, firewall)
  p result
rescue CircuitIDAPIClient::ApiError => e
...
> <Array(Object, Integer, Hash)> patch_firewall_with_http_info(id, firewall)

```ruby
begin
  # Patch object's data
  data, status_code, headers = api_instance.patch_firewall_with_http_info(id, firewall)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => Object
rescue CircuitIDAPIClient::ApiError => e
...
> <Array(Object, Integer, Hash)> remove_firewall_with_http_info(id)
