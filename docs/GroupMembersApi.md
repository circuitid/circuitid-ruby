# CircuitIDAPIClient::GroupMembersApi
...
api_instance = CircuitIDAPIClient::GroupMembersApi.new
groupmembers = CircuitIDAPIClient::Groupmembers.new({group: 3.56, object: 3.56, ref: users}) # Groupmembers | The JSON object that will be posted to the REST API endpoint.
...
api_instance = CircuitIDAPIClient::GroupMembersApi.new
id = TODO # Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
groupmembers = CircuitIDAPIClient::Groupmembers.new({group: 3.56, object: 3.56, ref: users}) # Groupmembers | The request data.
