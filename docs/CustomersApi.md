...
customers = CircuitID::Customers.new({name: 3.56, default_bill_method: credit}) # Customers | The JSON object that will be posted to the REST API endpoint.
...
api_instance = CircuitID::CustomersApi.new
id = TODO # Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
customers = CircuitID::Customers.new({name: 3.56, default_bill_method: credit}) # Customers | The request data.
