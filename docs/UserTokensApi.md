...
usertokens = CircuitID::Usertokens.new({name: 3.56, user: 3.56, token: 3.56, expires_in_years: 3.56}) # Usertokens | The JSON object that will be posted to the REST API endpoint.
...
api_instance = CircuitID::UserTokensApi.new
id = TODO # Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
usertokens = CircuitID::Usertokens.new({name: 3.56, user: 3.56, token: 3.56, expires_in_years: 3.56}) # Usertokens | The request data.
