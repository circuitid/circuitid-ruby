# CircuitIDAPIClient::DirectoriesApi
...
api_instance = CircuitIDAPIClient::DirectoriesApi.new
directories = CircuitIDAPIClient::Directories.new({name: 3.56, type: customers}) # Directories | The JSON object that will be posted to the REST API endpoint.
...
api_instance = CircuitIDAPIClient::DirectoriesApi.new
id = TODO # Object | The ObjectId (unique 12 bytes ID) of record you would like to GET.
directories = CircuitIDAPIClient::Directories.new({name: 3.56, type: customers}) # Directories | The request data.
