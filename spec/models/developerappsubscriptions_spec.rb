...
# Unit tests for CircuitID::Developerappsubscriptions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CircuitID::Developerappsubscriptions do
  let(:instance) { CircuitID::Developerappsubscriptions.new }

  describe 'test an instance of Developerappsubscriptions' do
    it 'should create an instance of Developerappsubscriptions' do
      expect(instance).to be_instance_of(CircuitID::Developerappsubscriptions)
    end
  end
