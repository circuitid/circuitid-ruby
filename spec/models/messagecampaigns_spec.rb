...
# Unit tests for CircuitIDAPIClient::Messagecampaigns
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CircuitIDAPIClient::Messagecampaigns do
  let(:instance) { CircuitIDAPIClient::Messagecampaigns.new }

  describe 'test an instance of Messagecampaigns' do
    it 'should create an instance of Messagecampaigns' do
      expect(instance).to be_instance_of(CircuitIDAPIClient::Messagecampaigns)
    end
  end
