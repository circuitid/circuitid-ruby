...
# Unit tests for CircuitID::PhoneinboundruleactionsCreateOrPatch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CircuitID::PhoneinboundruleactionsCreateOrPatch do
  let(:instance) { CircuitID::PhoneinboundruleactionsCreateOrPatch.new }

  describe 'test an instance of PhoneinboundruleactionsCreateOrPatch' do
    it 'should create an instance of PhoneinboundruleactionsCreateOrPatch' do
      expect(instance).to be_instance_of(CircuitID::PhoneinboundruleactionsCreateOrPatch)
    end
  end
