...
# Unit tests for CircuitID::GetHoliday200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CircuitID::GetHoliday200Response do
  let(:instance) { CircuitID::GetHoliday200Response.new }

  describe 'test an instance of GetHoliday200Response' do
    it 'should create an instance of GetHoliday200Response' do
      expect(instance).to be_instance_of(CircuitID::GetHoliday200Response)
    end
  end
