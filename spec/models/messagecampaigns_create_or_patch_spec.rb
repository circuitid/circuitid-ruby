...
# Unit tests for CircuitID::MessagecampaignsCreateOrPatch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CircuitID::MessagecampaignsCreateOrPatch do
  let(:instance) { CircuitID::MessagecampaignsCreateOrPatch.new }

  describe 'test an instance of MessagecampaignsCreateOrPatch' do
    it 'should create an instance of MessagecampaignsCreateOrPatch' do
      expect(instance).to be_instance_of(CircuitID::MessagecampaignsCreateOrPatch)
    end
  end
