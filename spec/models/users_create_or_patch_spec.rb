...
# Unit tests for CircuitID::UsersCreateOrPatch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CircuitID::UsersCreateOrPatch do
  let(:instance) { CircuitID::UsersCreateOrPatch.new }

  describe 'test an instance of UsersCreateOrPatch' do
    it 'should create an instance of UsersCreateOrPatch' do
      expect(instance).to be_instance_of(CircuitID::UsersCreateOrPatch)
    end
  end
