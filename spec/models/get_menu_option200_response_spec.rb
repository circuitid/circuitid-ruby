...
# Unit tests for CircuitID::GetMenuOption200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CircuitID::GetMenuOption200Response do
  let(:instance) { CircuitID::GetMenuOption200Response.new }

  describe 'test an instance of GetMenuOption200Response' do
    it 'should create an instance of GetMenuOption200Response' do
      expect(instance).to be_instance_of(CircuitID::GetMenuOption200Response)
    end
  end
