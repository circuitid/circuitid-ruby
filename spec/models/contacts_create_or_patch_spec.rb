...
# Unit tests for CircuitID::ContactsCreateOrPatch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CircuitID::ContactsCreateOrPatch do
  let(:instance) { CircuitID::ContactsCreateOrPatch.new }

  describe 'test an instance of ContactsCreateOrPatch' do
    it 'should create an instance of ContactsCreateOrPatch' do
      expect(instance).to be_instance_of(CircuitID::ContactsCreateOrPatch)
    end
  end
