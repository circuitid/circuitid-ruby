...
# Unit tests for CircuitID::GetContact200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CircuitID::GetContact200Response do
  let(:instance) { CircuitID::GetContact200Response.new }

  describe 'test an instance of GetContact200Response' do
    it 'should create an instance of GetContact200Response' do
      expect(instance).to be_instance_of(CircuitID::GetContact200Response)
    end
  end
