...
# Unit tests for CircuitIDAPIClient::Contacts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CircuitIDAPIClient::Contacts do
  let(:instance) { CircuitIDAPIClient::Contacts.new }

  describe 'test an instance of Contacts' do
    it 'should create an instance of Contacts' do
      expect(instance).to be_instance_of(CircuitIDAPIClient::Contacts)
    end
  end
