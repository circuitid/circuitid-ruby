...
# Unit tests for CircuitID::Conversations
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CircuitID::Conversations do
  let(:instance) { CircuitID::Conversations.new }

  describe 'test an instance of Conversations' do
    it 'should create an instance of Conversations' do
      expect(instance).to be_instance_of(CircuitID::Conversations)
    end
  end
