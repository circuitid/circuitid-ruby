...
# Unit tests for CircuitID::MenuoptionsCreateOrPatch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CircuitID::MenuoptionsCreateOrPatch do
  let(:instance) { CircuitID::MenuoptionsCreateOrPatch.new }

  describe 'test an instance of MenuoptionsCreateOrPatch' do
    it 'should create an instance of MenuoptionsCreateOrPatch' do
      expect(instance).to be_instance_of(CircuitID::MenuoptionsCreateOrPatch)
    end
  end
