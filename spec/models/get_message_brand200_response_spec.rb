...
# Unit tests for CircuitID::GetMessageBrand200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CircuitID::GetMessageBrand200Response do
  let(:instance) { CircuitID::GetMessageBrand200Response.new }

  describe 'test an instance of GetMessageBrand200Response' do
    it 'should create an instance of GetMessageBrand200Response' do
      expect(instance).to be_instance_of(CircuitID::GetMessageBrand200Response)
    end
  end
