...
# Unit tests for CircuitID::GetPhoneInboundRuleAction200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CircuitID::GetPhoneInboundRuleAction200Response do
  let(:instance) { CircuitID::GetPhoneInboundRuleAction200Response.new }

  describe 'test an instance of GetPhoneInboundRuleAction200Response' do
    it 'should create an instance of GetPhoneInboundRuleAction200Response' do
      expect(instance).to be_instance_of(CircuitID::GetPhoneInboundRuleAction200Response)
    end
  end
