...
# Unit tests for CircuitID::NumbersCreateOrPatch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CircuitID::NumbersCreateOrPatch do
  let(:instance) { CircuitID::NumbersCreateOrPatch.new }

  describe 'test an instance of NumbersCreateOrPatch' do
    it 'should create an instance of NumbersCreateOrPatch' do
      expect(instance).to be_instance_of(CircuitID::NumbersCreateOrPatch)
    end
  end
