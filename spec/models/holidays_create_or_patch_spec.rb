...
# Unit tests for CircuitID::HolidaysCreateOrPatch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CircuitID::HolidaysCreateOrPatch do
  let(:instance) { CircuitID::HolidaysCreateOrPatch.new }

  describe 'test an instance of HolidaysCreateOrPatch' do
    it 'should create an instance of HolidaysCreateOrPatch' do
      expect(instance).to be_instance_of(CircuitID::HolidaysCreateOrPatch)
    end
  end
