...
# Unit tests for CircuitIDAPIClient::Numbers
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe CircuitIDAPIClient::Numbers do
  let(:instance) { CircuitIDAPIClient::Numbers.new }

  describe 'test an instance of Numbers' do
    it 'should create an instance of Numbers' do
      expect(instance).to be_instance_of(CircuitIDAPIClient::Numbers)
    end
  end
