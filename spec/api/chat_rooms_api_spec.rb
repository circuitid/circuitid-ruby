...
# Unit tests for CircuitID::ChatRoomsApi
...
describe 'ChatRoomsApi' do
  ...
  describe 'test an instance of ChatRoomsApi' do
    it 'should create an instance of ChatRoomsApi' do
      expect(@api_instance).to be_instance_of(CircuitID::ChatRoomsApi)
    end
  end
  ...
  # @param chatrooms_create_or_patch The JSON object that will be posted to the REST API endpoint.
  ...
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param chatrooms_create_or_patch The request data.
  # @param [Hash] opts the optional parameters
  # @return [GetChatRoom200Response]
