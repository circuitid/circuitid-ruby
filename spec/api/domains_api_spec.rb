...
# Unit tests for CircuitID::DomainsApi
...
describe 'DomainsApi' do
  ...
  describe 'test an instance of DomainsApi' do
    it 'should create an instance of DomainsApi' do
      expect(@api_instance).to be_instance_of(CircuitID::DomainsApi)
    end
  end
  ...
  # @param domains_create_or_patch The JSON object that will be posted to the REST API endpoint.
  ...
  # unit tests for patch_domain
  # Patch object&#39;s data
  # Make updates to specific fields within the record without replacing the entire dataset.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param domains_create_or_patch The request data.
  # @param [Hash] opts the optional parameters
  # @return [GetDomain200Response]
  describe 'patch_domain test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
