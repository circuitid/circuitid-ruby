...
# Unit tests for CircuitIDAPIClient::DomainsApi
...
describe 'DomainsApi' do
  ...
  describe 'test an instance of DomainsApi' do
    it 'should create an instance of DomainsApi' do
      expect(@api_instance).to be_instance_of(CircuitIDAPIClient::DomainsApi)
    end
  end
  ...
  # @param domains The JSON object that will be posted to the REST API endpoint.
  ...
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param domains The request data.
  # @param [Hash] opts the optional parameters
  # @return [Object]
