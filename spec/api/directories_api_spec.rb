...
# Unit tests for CircuitIDAPIClient::DirectoriesApi
...
describe 'DirectoriesApi' do
  ...
  describe 'test an instance of DirectoriesApi' do
    it 'should create an instance of DirectoriesApi' do
      expect(@api_instance).to be_instance_of(CircuitIDAPIClient::DirectoriesApi)
    end
  end

  # unit tests for create_directorie
  # Create a new object
  # Add a new object to the system.
  # @param directories The JSON object that will be posted to the REST API endpoint.
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'create_directorie test' do
    it 'should work' do
  ...
  # unit tests for get_directorie
  # Get object by id
  # Get an object from the REST API Endpoint by its unique id.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'get_directorie test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for patch_directorie
  # Patch object&#39;s data
  ...
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'patch_directorie test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for remove_directorie
  # Delete object by id
  # Delete an object by id, removing it from the service.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'remove_directorie test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
