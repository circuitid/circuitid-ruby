...
# Unit tests for CircuitID::ClientsApi
...
describe 'ClientsApi' do
  ...
  describe 'test an instance of ClientsApi' do
    it 'should create an instance of ClientsApi' do
      expect(@api_instance).to be_instance_of(CircuitID::ClientsApi)
    end
  end
  ...
  # @param clients_create_or_patch The JSON object that will be posted to the REST API endpoint.
  ...
  # unit tests for patch_client
  # Patch object&#39;s data
  # Make updates to specific fields within the record without replacing the entire dataset.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param clients_create_or_patch The request data.
  # @param [Hash] opts the optional parameters
  # @return [GetClient200Response]
  describe 'patch_client test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for remove_client
  # Delete object by id
  # Delete an object by id, removing it from the service.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param [Hash] opts the optional parameters
  # @return [GetClient200Response]
  describe 'remove_client test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
