...
# Unit tests for CircuitIDAPIClient::ClientsApi
...
describe 'ClientsApi' do
  ...
  describe 'test an instance of ClientsApi' do
    it 'should create an instance of ClientsApi' do
      expect(@api_instance).to be_instance_of(CircuitIDAPIClient::ClientsApi)
    end
  end
  ...
  # @param clients The JSON object that will be posted to the REST API endpoint.
  ...
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param clients The request data.
  # @param [Hash] opts the optional parameters
  # @return [Object]
