...
# Unit tests for CircuitID::FirewallApi
...
describe 'FirewallApi' do
  ...
  describe 'test an instance of FirewallApi' do
    it 'should create an instance of FirewallApi' do
      expect(@api_instance).to be_instance_of(CircuitID::FirewallApi)
    end
  end
  ...
  # @param firewall_create_or_patch The JSON object that will be posted to the REST API endpoint.
  ...
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param firewall_create_or_patch The request data.
  # @param [Hash] opts the optional parameters
  # @return [GetFirewall200Response]
