...
# Unit tests for CircuitIDAPIClient::FindNumbersApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'FindNumbersApi' do
  before do
  ...
  describe 'test an instance of FindNumbersApi' do
    it 'should create an instance of FindNumbersApi' do
      expect(@api_instance).to be_instance_of(CircuitIDAPIClient::FindNumbersApi)
    end
  end

  # unit tests for find_find_numbers
  ...
  # @return [Object]
  describe 'find_find_numbers test' do
    it 'should work' do
