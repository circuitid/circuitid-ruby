...
# Unit tests for CircuitID::FaxAccountsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'FaxAccountsApi' do
  before do
  ...
  describe 'test an instance of FaxAccountsApi' do
    it 'should create an instance of FaxAccountsApi' do
      expect(@api_instance).to be_instance_of(CircuitID::FaxAccountsApi)
    end
  end
  ...
  # @param faxaccounts_create_or_patch The JSON object that will be posted to the REST API endpoint.
  ...
  # unit tests for find_fax_accounts
  ...
  describe 'find_fax_accounts test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param faxaccounts_create_or_patch The request data.
  # @param [Hash] opts the optional parameters
  # @return [GetFaxAccount200Response]
