...
# Unit tests for CircuitID::GroupMembersApi
...
describe 'GroupMembersApi' do
  ...
  describe 'test an instance of GroupMembersApi' do
    it 'should create an instance of GroupMembersApi' do
      expect(@api_instance).to be_instance_of(CircuitID::GroupMembersApi)
    end
  end
  ...
  # @param groupmembers_create_or_patch The JSON object that will be posted to the REST API endpoint.
  ...
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param groupmembers_create_or_patch The request data.
  # @param [Hash] opts the optional parameters
  # @return [GetGroupMember200Response]
