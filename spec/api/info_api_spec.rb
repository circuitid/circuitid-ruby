...
# Unit tests for CircuitIDAPIClient::InfoApi
...
describe 'InfoApi' do
  ...
  describe 'test an instance of InfoApi' do
    it 'should create an instance of InfoApi' do
      expect(@api_instance).to be_instance_of(CircuitIDAPIClient::InfoApi)
    end
  end

  # unit tests for find_info
  # Get object
  # Returns an object containing the requested information.
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'find_info test' do
    it 'should work' do
