...
# Unit tests for CircuitIDAPIClient::HolidaysApi
...
describe 'HolidaysApi' do
  ...
  describe 'test an instance of HolidaysApi' do
    it 'should create an instance of HolidaysApi' do
      expect(@api_instance).to be_instance_of(CircuitIDAPIClient::HolidaysApi)
    end
  end
  ...
  # @param holidays The JSON object that will be posted to the REST API endpoint.
  ...
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param holidays The request data.
  # @param [Hash] opts the optional parameters
  # @return [Object]
