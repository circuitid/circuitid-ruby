...
# Unit tests for CircuitID::HolidaysApi
...
describe 'HolidaysApi' do
  ...
  describe 'test an instance of HolidaysApi' do
    it 'should create an instance of HolidaysApi' do
      expect(@api_instance).to be_instance_of(CircuitID::HolidaysApi)
    end
  end
  ...
  # @param holidays_create_or_patch The JSON object that will be posted to the REST API endpoint.
  ...
  describe 'find_holidays test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for patch_holiday
  # Patch object&#39;s data
  # Make updates to specific fields within the record without replacing the entire dataset.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param holidays_create_or_patch The request data.
  # @param [Hash] opts the optional parameters
  # @return [GetHoliday200Response]
  describe 'patch_holiday test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for remove_holiday
  # Delete object by id
  # Delete an object by id, removing it from the service.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param [Hash] opts the optional parameters
  # @return [GetHoliday200Response]
  describe 'remove_holiday test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
