...
# Unit tests for CircuitIDAPIClient::ConversationsApi
...
describe 'ConversationsApi' do
  ...
  describe 'test an instance of ConversationsApi' do
    it 'should create an instance of ConversationsApi' do
      expect(@api_instance).to be_instance_of(CircuitIDAPIClient::ConversationsApi)
    end
  end
  ...
  # @param conversations The JSON object that will be posted to the REST API endpoint.
  ...
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param conversations The request data.
  # @param [Hash] opts the optional parameters
  # @return [Object]
