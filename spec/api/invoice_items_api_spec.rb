...
# Unit tests for CircuitIDAPIClient::InvoiceItemsApi
...
describe 'InvoiceItemsApi' do
  ...
  describe 'test an instance of InvoiceItemsApi' do
    it 'should create an instance of InvoiceItemsApi' do
      expect(@api_instance).to be_instance_of(CircuitIDAPIClient::InvoiceItemsApi)
    end
  end

  # unit tests for find_invoice_items
