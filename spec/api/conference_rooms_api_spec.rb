...
# Unit tests for CircuitID::ConferenceRoomsApi
...
describe 'ConferenceRoomsApi' do
  ...
  describe 'test an instance of ConferenceRoomsApi' do
    it 'should create an instance of ConferenceRoomsApi' do
      expect(@api_instance).to be_instance_of(CircuitID::ConferenceRoomsApi)
    end
  end
  ...
  # @param conferencerooms_create_or_patch The JSON object that will be posted to the REST API endpoint.
  ...
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param conferencerooms_create_or_patch The request data.
  # @param [Hash] opts the optional parameters
  # @return [GetConferenceRoom200Response]
