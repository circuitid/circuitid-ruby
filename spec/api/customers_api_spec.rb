...
# Unit tests for CircuitIDAPIClient::CustomersApi
...
describe 'CustomersApi' do
  ...
  describe 'test an instance of CustomersApi' do
    it 'should create an instance of CustomersApi' do
      expect(@api_instance).to be_instance_of(CircuitIDAPIClient::CustomersApi)
    end
  end
  ...
  # @param customers The JSON object that will be posted to the REST API endpoint.
  ...
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param customers The request data.
  # @param [Hash] opts the optional parameters
  # @return [Object]
  ...
  # unit tests for remove_customer
  # Delete object by id
  # Delete an object by id, removing it from the service.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'remove_customer test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
