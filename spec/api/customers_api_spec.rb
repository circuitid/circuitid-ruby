...
# Unit tests for CircuitID::CustomersApi
...
describe 'CustomersApi' do
  ...
  describe 'test an instance of CustomersApi' do
    it 'should create an instance of CustomersApi' do
      expect(@api_instance).to be_instance_of(CircuitID::CustomersApi)
    end
  end
  ...
  # @param customers_create_or_patch The JSON object that will be posted to the REST API endpoint.
  ...
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param customers_create_or_patch The request data.
  # @param [Hash] opts the optional parameters
  # @return [GetCustomer200Response]
