...
# Unit tests for CircuitID::ContactsApi
...
describe 'ContactsApi' do
  ...
  describe 'test an instance of ContactsApi' do
    it 'should create an instance of ContactsApi' do
      expect(@api_instance).to be_instance_of(CircuitID::ContactsApi)
    end
  end
  ...
  # @param contacts_create_or_patch The JSON object that will be posted to the REST API endpoint.
  ...
  describe 'find_contacts test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param contacts_create_or_patch The request data.
  # @param [Hash] opts the optional parameters
  # @return [GetContact200Response]
  ...
  # unit tests for remove_contact
  # Delete object by id
  # Delete an object by id, removing it from the service.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param [Hash] opts the optional parameters
  # @return [GetContact200Response]
  describe 'remove_contact test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
