...
# Unit tests for CircuitIDAPIClient::ContactsApi
...
describe 'ContactsApi' do
  ...
  describe 'test an instance of ContactsApi' do
    it 'should create an instance of ContactsApi' do
      expect(@api_instance).to be_instance_of(CircuitIDAPIClient::ContactsApi)
    end
  end
  ...
  # @param contacts The JSON object that will be posted to the REST API endpoint.
  ...
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param contacts The request data.
  # @param [Hash] opts the optional parameters
  # @return [Object]
