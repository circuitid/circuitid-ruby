...
# Unit tests for CircuitIDAPIClient::AppMarketplaceApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AppMarketplaceApi' do
  before do
  ...
  describe 'test an instance of AppMarketplaceApi' do
    it 'should create an instance of AppMarketplaceApi' do
      expect(@api_instance).to be_instance_of(CircuitIDAPIClient::AppMarketplaceApi)
    end
  end

  # unit tests for find_app_marketplace
  ...
  # @return [Object]
  describe 'find_app_marketplace test' do
    it 'should work' do
