...
# Unit tests for CircuitIDAPIClient::LicensesApi
...
describe 'LicensesApi' do
  ...
  describe 'test an instance of LicensesApi' do
    it 'should create an instance of LicensesApi' do
      expect(@api_instance).to be_instance_of(CircuitIDAPIClient::LicensesApi)
    end
  end
  ...
  # @param licenses The JSON object that will be posted to the REST API endpoint.
  ...
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param licenses The request data.
  # @param [Hash] opts the optional parameters
  # @return [Object]
