...
# Unit tests for CircuitID::MessageCampaignsApi
...
describe 'MessageCampaignsApi' do
  ...
  describe 'test an instance of MessageCampaignsApi' do
    it 'should create an instance of MessageCampaignsApi' do
      expect(@api_instance).to be_instance_of(CircuitID::MessageCampaignsApi)
    end
  end
  ...
  # @param messagecampaigns_create_or_patch The JSON object that will be posted to the REST API endpoint.
  ...
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param messagecampaigns_create_or_patch The request data.
  # @param [Hash] opts the optional parameters
  # @return [GetMessageCampaign200Response]
