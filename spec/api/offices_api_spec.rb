...
# Unit tests for CircuitID::OfficesApi
...
describe 'OfficesApi' do
  ...
  describe 'test an instance of OfficesApi' do
    it 'should create an instance of OfficesApi' do
      expect(@api_instance).to be_instance_of(CircuitID::OfficesApi)
    end
  end
  ...
  # @param offices_create_or_patch The JSON object that will be posted to the REST API endpoint.
  ...
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param offices_create_or_patch The request data.
  # @param [Hash] opts the optional parameters
  # @return [GetOffice200Response]
