...
# Unit tests for CircuitIDAPIClient::RateCentersApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RateCentersApi' do
  before do
  ...
  describe 'test an instance of RateCentersApi' do
    it 'should create an instance of RateCentersApi' do
      expect(@api_instance).to be_instance_of(CircuitIDAPIClient::RateCentersApi)
    end
  end

  # unit tests for find_rate_centers
