...
# Unit tests for CircuitIDAPIClient::AnnouncementsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AnnouncementsApi' do
  before do
  ...
  describe 'test an instance of AnnouncementsApi' do
    it 'should create an instance of AnnouncementsApi' do
      expect(@api_instance).to be_instance_of(CircuitIDAPIClient::AnnouncementsApi)
    end
  end
  ...
  # @param announcements The JSON object that will be posted to the REST API endpoint.
  ...
  # unit tests for find_announcements
  ...
  describe 'find_announcements test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_announcement
  # Get object by id
  # Get an object from the REST API Endpoint by its unique id.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'get_announcement test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for patch_announcement
  # Patch object&#39;s data
  # Make updates to specific fields within the record without replacing the entire dataset.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param announcements The request data.
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'patch_announcement test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for remove_announcement
  # Delete object by id
  # Delete an object by id, removing it from the service.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'remove_announcement test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
