...
# Unit tests for CircuitID::AnnouncementsApi
...
describe 'AnnouncementsApi' do
  ...
  describe 'test an instance of AnnouncementsApi' do
    it 'should create an instance of AnnouncementsApi' do
      expect(@api_instance).to be_instance_of(CircuitID::AnnouncementsApi)
    end
  end
  ...
  # @param announcements_create_or_patch The JSON object that will be posted to the REST API endpoint.
  ...
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param announcements_create_or_patch The request data.
  # @param [Hash] opts the optional parameters
  # @return [GetAnnouncement200Response]
