...
# Unit tests for CircuitIDAPIClient::VoicemailApi
...
describe 'VoicemailApi' do
  ...
  describe 'test an instance of VoicemailApi' do
    it 'should create an instance of VoicemailApi' do
      expect(@api_instance).to be_instance_of(CircuitIDAPIClient::VoicemailApi)
    end
  end

  # unit tests for find_voicemail
