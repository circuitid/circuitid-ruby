...
# Unit tests for CircuitIDAPIClient::ServersApi
...
describe 'ServersApi' do
  ...
  describe 'test an instance of ServersApi' do
    it 'should create an instance of ServersApi' do
      expect(@api_instance).to be_instance_of(CircuitIDAPIClient::ServersApi)
    end
  end
  ...
  # @param servers The JSON object that will be posted to the REST API endpoint.
  ...
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param servers The request data.
  # @param [Hash] opts the optional parameters
  # @return [Object]
