...
# Unit tests for CircuitID::ServersApi
...
describe 'ServersApi' do
  ...
  describe 'test an instance of ServersApi' do
    it 'should create an instance of ServersApi' do
      expect(@api_instance).to be_instance_of(CircuitID::ServersApi)
    end
  end

  # unit tests for create_server
  # Create a new object
  # Add a new object to the system.
  # @param servers_create_or_patch The JSON object that will be posted to the REST API endpoint.
  # @param [Hash] opts the optional parameters
  # @return [GetServer200Response]
  describe 'create_server test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for find_servers
  ...
  describe 'find_servers test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_server
  # Get object by id
  # Get an object from the REST API Endpoint by its unique id.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param [Hash] opts the optional parameters
  # @return [GetServer200Response]
  describe 'get_server test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for patch_server
  # Patch object&#39;s data
  # Make updates to specific fields within the record without replacing the entire dataset.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param servers_create_or_patch The request data.
  # @param [Hash] opts the optional parameters
  # @return [GetServer200Response]
  describe 'patch_server test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for remove_server
  # Delete object by id
  # Delete an object by id, removing it from the service.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param [Hash] opts the optional parameters
  # @return [GetServer200Response]
  describe 'remove_server test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
