...
# Unit tests for CircuitID::CallQueuesApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CallQueuesApi' do
  before do
  ...
  describe 'test an instance of CallQueuesApi' do
    it 'should create an instance of CallQueuesApi' do
      expect(@api_instance).to be_instance_of(CircuitID::CallQueuesApi)
    end
  end
  ...
  # @param callqueues_create_or_patch The JSON object that will be posted to the REST API endpoint.
  ...
  # unit tests for find_call_queues
  ...
  describe 'find_call_queues test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_call_queue
  # Get object by id
  # Get an object from the REST API Endpoint by its unique id.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param [Hash] opts the optional parameters
  # @return [GetCallQueue200Response]
  describe 'get_call_queue test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for patch_call_queue
  # Patch object&#39;s data
  # Make updates to specific fields within the record without replacing the entire dataset.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param callqueues_create_or_patch The request data.
  # @param [Hash] opts the optional parameters
  # @return [GetCallQueue200Response]
  describe 'patch_call_queue test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for remove_call_queue
  # Delete object by id
  # Delete an object by id, removing it from the service.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param [Hash] opts the optional parameters
  # @return [GetCallQueue200Response]
  describe 'remove_call_queue test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
