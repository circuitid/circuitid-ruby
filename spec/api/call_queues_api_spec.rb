...
# Unit tests for CircuitIDAPIClient::CallQueuesApi
...
describe 'CallQueuesApi' do
  ...
  describe 'test an instance of CallQueuesApi' do
    it 'should create an instance of CallQueuesApi' do
      expect(@api_instance).to be_instance_of(CircuitIDAPIClient::CallQueuesApi)
    end
  end
  ...
  # @param callqueues The JSON object that will be posted to the REST API endpoint.
  ...
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param callqueues The request data.
  # @param [Hash] opts the optional parameters
  # @return [Object]
