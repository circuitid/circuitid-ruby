...
# Unit tests for CircuitIDAPIClient::MenusApi
...
describe 'MenusApi' do
  ...
  describe 'test an instance of MenusApi' do
    it 'should create an instance of MenusApi' do
      expect(@api_instance).to be_instance_of(CircuitIDAPIClient::MenusApi)
    end
  end
  ...
  # @param menus The JSON object that will be posted to the REST API endpoint.
  ...
  # unit tests for patch_menu
  # Patch object&#39;s data
  # Make updates to specific fields within the record without replacing the entire dataset.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param menus The request data.
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'patch_menu test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for remove_menu
  # Delete object by id
  # Delete an object by id, removing it from the service.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'remove_menu test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
