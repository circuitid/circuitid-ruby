...
# Unit tests for CircuitID::MenusApi
...
describe 'MenusApi' do
  ...
  describe 'test an instance of MenusApi' do
    it 'should create an instance of MenusApi' do
      expect(@api_instance).to be_instance_of(CircuitID::MenusApi)
    end
  end
  ...
  # @param menus_create_or_patch The JSON object that will be posted to the REST API endpoint.
  ...
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param menus_create_or_patch The request data.
  # @param [Hash] opts the optional parameters
  # @return [GetMenu200Response]
