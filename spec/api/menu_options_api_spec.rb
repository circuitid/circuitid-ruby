...
# Unit tests for CircuitID::MenuOptionsApi
...
describe 'MenuOptionsApi' do
  ...
  describe 'test an instance of MenuOptionsApi' do
    it 'should create an instance of MenuOptionsApi' do
      expect(@api_instance).to be_instance_of(CircuitID::MenuOptionsApi)
    end
  end
  ...
  # @param menuoptions_create_or_patch The JSON object that will be posted to the REST API endpoint.
  ...
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param menuoptions_create_or_patch The request data.
  # @param [Hash] opts the optional parameters
  # @return [GetMenuOption200Response]
