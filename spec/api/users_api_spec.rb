...
# Unit tests for CircuitID::UsersApi
...
describe 'UsersApi' do
  ...
  describe 'test an instance of UsersApi' do
    it 'should create an instance of UsersApi' do
      expect(@api_instance).to be_instance_of(CircuitID::UsersApi)
    end
  end
  ...
  # @param users_create_or_patch The JSON object that will be posted to the REST API endpoint.
  ...
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param users_create_or_patch The request data.
  # @param [Hash] opts the optional parameters
  # @return [GetUser200Response]
