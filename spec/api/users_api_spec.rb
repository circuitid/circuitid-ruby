...
# Unit tests for CircuitIDAPIClient::UsersApi
...
describe 'UsersApi' do
  ...
  describe 'test an instance of UsersApi' do
    it 'should create an instance of UsersApi' do
      expect(@api_instance).to be_instance_of(CircuitIDAPIClient::UsersApi)
    end
  end
  ...
  # @param users The JSON object that will be posted to the REST API endpoint.
