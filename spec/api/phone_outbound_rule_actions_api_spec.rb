...
describe 'PhoneOutboundRuleActionsApi' do
  ...
  # @param phoneoutboundruleactions_create_or_patch The JSON object that will be posted to the REST API endpoint.
  ...
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param phoneoutboundruleactions_create_or_patch The request data.
  # @param [Hash] opts the optional parameters
  # @return [GetPhoneOutboundRuleAction200Response]
