...
# Unit tests for CircuitID::FaxesApi
...
describe 'FaxesApi' do
  ...
  describe 'test an instance of FaxesApi' do
    it 'should create an instance of FaxesApi' do
      expect(@api_instance).to be_instance_of(CircuitID::FaxesApi)
    end
  end

  # unit tests for create_fax
  # Create a new object
  # Add a new object to the system.
  # @param faxes_create_or_patch The JSON object that will be posted to the REST API endpoint.
  # @param [Hash] opts the optional parameters
  # @return [GetFax200Response]
  describe 'create_fax test' do
    it 'should work' do
  ...
  # unit tests for get_fax
  # Get object by id
  # Get an object from the REST API Endpoint by its unique id.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param [Hash] opts the optional parameters
  # @return [GetFax200Response]
  describe 'get_fax test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for remove_fax
  # Delete object by id
  # Delete an object by id, removing it from the service.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param [Hash] opts the optional parameters
  # @return [GetFax200Response]
  describe 'remove_fax test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
