...
# Unit tests for CircuitIDAPIClient::DeveloperAppsApi
...
describe 'DeveloperAppsApi' do
  ...
  describe 'test an instance of DeveloperAppsApi' do
    it 'should create an instance of DeveloperAppsApi' do
      expect(@api_instance).to be_instance_of(CircuitIDAPIClient::DeveloperAppsApi)
    end
  end
  ...
  # @param developerapps The JSON object that will be posted to the REST API endpoint.
  ...
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param developerapps The request data.
  # @param [Hash] opts the optional parameters
  # @return [Object]
