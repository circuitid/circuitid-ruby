...
# Unit tests for CircuitID::DeveloperAppsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'DeveloperAppsApi' do
  before do
  ...
  describe 'test an instance of DeveloperAppsApi' do
    it 'should create an instance of DeveloperAppsApi' do
      expect(@api_instance).to be_instance_of(CircuitID::DeveloperAppsApi)
    end
  end

  # unit tests for create_developer_app
  # Create a new object
  # Add a new object to the system.
  # @param developerapps_create_or_patch The JSON object that will be posted to the REST API endpoint.
  # @param [Hash] opts the optional parameters
  # @return [GetDeveloperApp200Response]
  describe 'create_developer_app test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for find_developer_apps
  ...
  describe 'find_developer_apps test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_developer_app
  # Get object by id
  # Get an object from the REST API Endpoint by its unique id.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param [Hash] opts the optional parameters
  # @return [GetDeveloperApp200Response]
  describe 'get_developer_app test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for patch_developer_app
  # Patch object&#39;s data
  # Make updates to specific fields within the record without replacing the entire dataset.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param developerapps_create_or_patch The request data.
  # @param [Hash] opts the optional parameters
  # @return [GetDeveloperApp200Response]
  describe 'patch_developer_app test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for remove_developer_app
  # Delete object by id
  # Delete an object by id, removing it from the service.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param [Hash] opts the optional parameters
  # @return [GetDeveloperApp200Response]
  describe 'remove_developer_app test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
