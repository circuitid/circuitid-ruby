...
# Unit tests for CircuitID::AcceptedSendersApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AcceptedSendersApi' do
  before do
  ...
  describe 'test an instance of AcceptedSendersApi' do
    it 'should create an instance of AcceptedSendersApi' do
      expect(@api_instance).to be_instance_of(CircuitID::AcceptedSendersApi)
    end
  end

  # unit tests for create_accepted_sender
  # Create a new object
  # Add a new object to the system.
  # @param acceptedsenders_create_or_patch The JSON object that will be posted to the REST API endpoint.
  # @param [Hash] opts the optional parameters
  # @return [GetAcceptedSender200Response]
  describe 'create_accepted_sender test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for find_accepted_senders
  ...
  describe 'find_accepted_senders test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_accepted_sender
  # Get object by id
  # Get an object from the REST API Endpoint by its unique id.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param [Hash] opts the optional parameters
  # @return [GetAcceptedSender200Response]
  describe 'get_accepted_sender test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for patch_accepted_sender
  # Patch object&#39;s data
  # Make updates to specific fields within the record without replacing the entire dataset.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param acceptedsenders_create_or_patch The request data.
  # @param [Hash] opts the optional parameters
  # @return [GetAcceptedSender200Response]
  describe 'patch_accepted_sender test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for remove_accepted_sender
  # Delete object by id
  # Delete an object by id, removing it from the service.
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param [Hash] opts the optional parameters
  # @return [GetAcceptedSender200Response]
  describe 'remove_accepted_sender test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
