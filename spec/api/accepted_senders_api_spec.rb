...
# Unit tests for CircuitIDAPIClient::AcceptedSendersApi
...
describe 'AcceptedSendersApi' do
  ...
  describe 'test an instance of AcceptedSendersApi' do
    it 'should create an instance of AcceptedSendersApi' do
      expect(@api_instance).to be_instance_of(CircuitIDAPIClient::AcceptedSendersApi)
    end
  end
  ...
  # @param acceptedsenders The JSON object that will be posted to the REST API endpoint.
  ...
  # @param id The ObjectId (unique 12 bytes ID) of record you would like to GET.
  # @param acceptedsenders The request data.
  # @param [Hash] opts the optional parameters
  # @return [Object]
