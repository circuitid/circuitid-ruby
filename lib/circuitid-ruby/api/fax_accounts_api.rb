  ...
  class FaxAccountsApi
    ...
    def create_fax_account_with_http_info(faxaccounts, opts = {})
      ...
      if @api_client.config.client_side_validation && faxaccounts.nil?
        fail ArgumentError, "Missing the required parameter 'faxaccounts' when calling FaxAccountsApi.create_fax_account"
      end
      # resource path
    ...
    def patch_fax_account_with_http_info(id, faxaccounts, opts = {})
      ...
      # verify the required parameter 'faxaccounts' is set
      if @api_client.config.client_side_validation && faxaccounts.nil?
        fail ArgumentError, "Missing the required parameter 'faxaccounts' when calling FaxAccountsApi.patch_fax_account"
      end
      # resource path
      local_var_path = '/faxaccounts/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
