...
module CircuitID
  class AcceptedSendersApi
    ...
    # @param acceptedsenders_create_or_patch [AcceptedsendersCreateOrPatch] The JSON object that will be posted to the REST API endpoint.
    # @param [Hash] opts the optional parameters
    # @return [GetAcceptedSender200Response]
    def create_accepted_sender(acceptedsenders_create_or_patch, opts = {})
      data, _status_code, _headers = create_accepted_sender_with_http_info(acceptedsenders_create_or_patch, opts)
      data
    end
    ...
    def create_accepted_sender_with_http_info(acceptedsenders_create_or_patch, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AcceptedSendersApi.create_accepted_sender ...'
      end
      # verify the required parameter 'acceptedsenders_create_or_patch' is set
      if @api_client.config.client_side_validation && acceptedsenders_create_or_patch.nil?
        fail ArgumentError, "Missing the required parameter 'acceptedsenders_create_or_patch' when calling AcceptedSendersApi.create_accepted_sender"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(acceptedsenders_create_or_patch)
    ...
    # @param id [String] The ObjectId (unique 12 bytes ID) of record you would like to GET.
    # @param acceptedsenders_create_or_patch [AcceptedsendersCreateOrPatch] The request data.
    # @param [Hash] opts the optional parameters
    # @return [GetAcceptedSender200Response]
    def patch_accepted_sender(id, acceptedsenders_create_or_patch, opts = {})
      data, _status_code, _headers = patch_accepted_sender_with_http_info(id, acceptedsenders_create_or_patch, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetAcceptedSender200Response, Integer, Hash)>] GetAcceptedSender200Response data, response status code and response headers
    def patch_accepted_sender_with_http_info(id, acceptedsenders_create_or_patch, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'acceptedsenders_create_or_patch' is set
      if @api_client.config.client_side_validation && acceptedsenders_create_or_patch.nil?
        fail ArgumentError, "Missing the required parameter 'acceptedsenders_create_or_patch' when calling AcceptedSendersApi.patch_accepted_sender"
      end
      # resource path
      local_var_path = '/acceptedsenders/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
