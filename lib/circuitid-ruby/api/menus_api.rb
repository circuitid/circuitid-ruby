...
module CircuitID
  class MenusApi
    ...
    # @param menus_create_or_patch [MenusCreateOrPatch] The JSON object that will be posted to the REST API endpoint.
    # @param [Hash] opts the optional parameters
    # @return [GetMenu200Response]
    def create_menu(menus_create_or_patch, opts = {})
      data, _status_code, _headers = create_menu_with_http_info(menus_create_or_patch, opts)
      data
    end
    ...
    # @param menus_create_or_patch [MenusCreateOrPatch] The JSON object that will be posted to the REST API endpoint.
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetMenu200Response, Integer, Hash)>] GetMenu200Response data, response status code and response headers
    def create_menu_with_http_info(menus_create_or_patch, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MenusApi.create_menu ...'
      end
      # verify the required parameter 'menus_create_or_patch' is set
      if @api_client.config.client_side_validation && menus_create_or_patch.nil?
        fail ArgumentError, "Missing the required parameter 'menus_create_or_patch' when calling MenusApi.create_menu"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(menus_create_or_patch)

      # return_type
      return_type = opts[:debug_return_type] || 'GetMenu200Response'
    ...
    # @param id [String] The ObjectId (unique 12 bytes ID) of record you would like to GET.
    # @param menus_create_or_patch [MenusCreateOrPatch] The request data.
    # @param [Hash] opts the optional parameters
    # @return [GetMenu200Response]
    def patch_menu(id, menus_create_or_patch, opts = {})
      data, _status_code, _headers = patch_menu_with_http_info(id, menus_create_or_patch, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetMenu200Response, Integer, Hash)>] GetMenu200Response data, response status code and response headers
    def patch_menu_with_http_info(id, menus_create_or_patch, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'menus_create_or_patch' is set
      if @api_client.config.client_side_validation && menus_create_or_patch.nil?
        fail ArgumentError, "Missing the required parameter 'menus_create_or_patch' when calling MenusApi.patch_menu"
      end
      # resource path
      local_var_path = '/menus/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
