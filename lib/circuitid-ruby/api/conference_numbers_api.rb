...
module CircuitID
  class ConferenceNumbersApi
    ...
    def find_conference_numbers(opts = {})
      data, _status_code, _headers = find_conference_numbers_with_http_info(opts)
      data
    end
    ...
    def find_conference_numbers_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConferenceNumbersApi.find_conference_numbers ...'
      end
      # resource path
      local_var_path = '/conferencenumbers'
      ...
      new_options = opts.merge(
        :operation => :"ConferenceNumbersApi.find_conference_numbers",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConferenceNumbersApi#find_conference_numbers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
