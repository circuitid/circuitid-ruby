...
module CircuitID
  class VoicemailApi
    ...
    # @option opts [Array<Object>] :_or Find all records that match any of the given criteria.
    # @option opts [Array<Object>] :_and Find all records that match all of the given criteria.
    # @return [Array<(FindAppMarketplace200Response, Integer, Hash)>] FindAppMarketplace200Response data, response status code and response headers
    def find_voicemail_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'FindAppMarketplace200Response'
