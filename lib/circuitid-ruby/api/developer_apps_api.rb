...
module CircuitID
  class DeveloperAppsApi
    ...
    # @param developerapps [Developerapps] The JSON object that will be posted to the REST API endpoint.
    # @param [Hash] opts the optional parameters
    # @return [GetDeveloperApp200Response]
    def create_developer_app(developerapps, opts = {})
      data, _status_code, _headers = create_developer_app_with_http_info(developerapps, opts)
      data
    end
    ...
    def create_developer_app_with_http_info(developerapps, opts = {})
      ...
      if @api_client.config.client_side_validation && developerapps.nil?
        fail ArgumentError, "Missing the required parameter 'developerapps' when calling DeveloperAppsApi.create_developer_app"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(developerapps)
    ...
    # @param id [String] The ObjectId (unique 12 bytes ID) of record you would like to GET.
    # @param developerapps [Developerapps] The request data.
    # @param [Hash] opts the optional parameters
    # @return [GetDeveloperApp200Response]
    def patch_developer_app(id, developerapps, opts = {})
      data, _status_code, _headers = patch_developer_app_with_http_info(id, developerapps, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetDeveloperApp200Response, Integer, Hash)>] GetDeveloperApp200Response data, response status code and response headers
    def patch_developer_app_with_http_info(id, developerapps, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'developerapps' is set
      if @api_client.config.client_side_validation && developerapps.nil?
        fail ArgumentError, "Missing the required parameter 'developerapps' when calling DeveloperAppsApi.patch_developer_app"
      end
      # resource path
      local_var_path = '/developerapps/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
