...
module CircuitID
  class ContactsApi
    ...
    # @param contacts_create_or_patch [ContactsCreateOrPatch] The JSON object that will be posted to the REST API endpoint.
    # @param [Hash] opts the optional parameters
    # @return [GetContact200Response]
    def create_contact(contacts_create_or_patch, opts = {})
      data, _status_code, _headers = create_contact_with_http_info(contacts_create_or_patch, opts)
      data
    end
    ...
    def create_contact_with_http_info(contacts_create_or_patch, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContactsApi.create_contact ...'
      end
      # verify the required parameter 'contacts_create_or_patch' is set
      if @api_client.config.client_side_validation && contacts_create_or_patch.nil?
        fail ArgumentError, "Missing the required parameter 'contacts_create_or_patch' when calling ContactsApi.create_contact"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(contacts_create_or_patch)
    ...
    def find_contacts(opts = {})
      data, _status_code, _headers = find_contacts_with_http_info(opts)
      data
    end
    ...
    # @option opts [Array<Object>] :_or Find all records that match any of the given criteria.
    # @option opts [Array<Object>] :_and Find all records that match all of the given criteria.
    # @return [Array<(FindContacts200Response, Integer, Hash)>] FindContacts200Response data, response status code and response headers
    def find_contacts_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContactsApi.find_contacts ...'
      end
      # resource path
      local_var_path = '/contacts'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'FindContacts200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['jwt']

      new_options = opts.merge(
        :operation => :"ContactsApi.find_contacts",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContactsApi#find_contacts\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param id [String] The ObjectId (unique 12 bytes ID) of record you would like to GET.
    # @param contacts_create_or_patch [ContactsCreateOrPatch] The request data.
    # @param [Hash] opts the optional parameters
    # @return [GetContact200Response]
    def patch_contact(id, contacts_create_or_patch, opts = {})
      data, _status_code, _headers = patch_contact_with_http_info(id, contacts_create_or_patch, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetContact200Response, Integer, Hash)>] GetContact200Response data, response status code and response headers
    def patch_contact_with_http_info(id, contacts_create_or_patch, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContactsApi.patch_contact ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ContactsApi.patch_contact"
      end
      # verify the required parameter 'contacts_create_or_patch' is set
      if @api_client.config.client_side_validation && contacts_create_or_patch.nil?
        fail ArgumentError, "Missing the required parameter 'contacts_create_or_patch' when calling ContactsApi.patch_contact"
      end
      # resource path
      local_var_path = '/contacts/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    # @param [Hash] opts the optional parameters
    # @return [GetContact200Response]
    def remove_contact(id, opts = {})
      data, _status_code, _headers = remove_contact_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetContact200Response, Integer, Hash)>] GetContact200Response data, response status code and response headers
    def remove_contact_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ContactsApi.remove_contact ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ContactsApi.remove_contact"
      end
      # resource path
      local_var_path = '/contacts/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ContactsApi.remove_contact",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ContactsApi#remove_contact\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
