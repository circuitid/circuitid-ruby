...
module CircuitID
  class ContactsApi
    ...
    # @param contacts [Contacts] The JSON object that will be posted to the REST API endpoint.
    # @param [Hash] opts the optional parameters
    # @return [GetContact200Response]
    def create_contact(contacts, opts = {})
      data, _status_code, _headers = create_contact_with_http_info(contacts, opts)
      data
    end
    ...
    def create_contact_with_http_info(contacts, opts = {})
      ...
      if @api_client.config.client_side_validation && contacts.nil?
        fail ArgumentError, "Missing the required parameter 'contacts' when calling ContactsApi.create_contact"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(contacts)
    ...
    # @param id [String] The ObjectId (unique 12 bytes ID) of record you would like to GET.
    # @param contacts [Contacts] The request data.
    # @param [Hash] opts the optional parameters
    # @return [GetContact200Response]
    def patch_contact(id, contacts, opts = {})
      data, _status_code, _headers = patch_contact_with_http_info(id, contacts, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetContact200Response, Integer, Hash)>] GetContact200Response data, response status code and response headers
    def patch_contact_with_http_info(id, contacts, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'contacts' is set
      if @api_client.config.client_side_validation && contacts.nil?
        fail ArgumentError, "Missing the required parameter 'contacts' when calling ContactsApi.patch_contact"
      end
      # resource path
      local_var_path = '/contacts/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
