...
module CircuitID
  class UsersApi
    ...
    # @param users_create_or_patch [UsersCreateOrPatch] The JSON object that will be posted to the REST API endpoint.
    # @param [Hash] opts the optional parameters
    # @return [GetUser200Response]
    def create_user(users_create_or_patch, opts = {})
      data, _status_code, _headers = create_user_with_http_info(users_create_or_patch, opts)
      data
    end
    ...
    def create_user_with_http_info(users_create_or_patch, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UsersApi.create_user ...'
      end
      # verify the required parameter 'users_create_or_patch' is set
      if @api_client.config.client_side_validation && users_create_or_patch.nil?
        fail ArgumentError, "Missing the required parameter 'users_create_or_patch' when calling UsersApi.create_user"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(users_create_or_patch)
    ...
    # @option opts [Array<Object>] :_or Find all records that match any of the given criteria.
    # @option opts [Array<Object>] :_and Find all records that match all of the given criteria.
    # @return [Array<(FindUsers200Response, Integer, Hash)>] FindUsers200Response data, response status code and response headers
    def find_users_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'FindUsers200Response'
    ...
    # @param id [String] The ObjectId (unique 12 bytes ID) of record you would like to GET.
    # @param users_create_or_patch [UsersCreateOrPatch] The request data.
    # @param [Hash] opts the optional parameters
    # @return [GetUser200Response]
    def patch_user(id, users_create_or_patch, opts = {})
      data, _status_code, _headers = patch_user_with_http_info(id, users_create_or_patch, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetUser200Response, Integer, Hash)>] GetUser200Response data, response status code and response headers
    def patch_user_with_http_info(id, users_create_or_patch, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'users_create_or_patch' is set
      if @api_client.config.client_side_validation && users_create_or_patch.nil?
        fail ArgumentError, "Missing the required parameter 'users_create_or_patch' when calling UsersApi.patch_user"
      end
      # resource path
      local_var_path = '/users/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
    ...
    def remove_user(id, opts = {})
      data, _status_code, _headers = remove_user_with_http_info(id, opts)
      data
    end
