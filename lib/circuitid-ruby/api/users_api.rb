...
module CircuitID
  class UsersApi
    ...
    # @param users [Users] The JSON object that will be posted to the REST API endpoint.
    # @param [Hash] opts the optional parameters
    # @return [Object]
    def create_user(users, opts = {})
      data, _status_code, _headers = create_user_with_http_info(users, opts)
      data
    end
    ...
    def create_user_with_http_info(users, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UsersApi.create_user ...'
      end
      # verify the required parameter 'users' is set
      if @api_client.config.client_side_validation && users.nil?
        fail ArgumentError, "Missing the required parameter 'users' when calling UsersApi.create_user"
      end
      # resource path
    ...
    # @param id [Object] The ObjectId (unique 12 bytes ID) of record you would like to GET.
    # @param users [Users] The request data.
    # @param [Hash] opts the optional parameters
    # @return [Object]
    def patch_user(id, users, opts = {})
      data, _status_code, _headers = patch_user_with_http_info(id, users, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Object, Integer, Hash)>] Object data, response status code and response headers
    def patch_user_with_http_info(id, users, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'users' is set
      if @api_client.config.client_side_validation && users.nil?
        fail ArgumentError, "Missing the required parameter 'users' when calling UsersApi.patch_user"
      end
      # resource path
      local_var_path = '/users/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
