...
module CircuitID
  class OfficesApi
    ...
    # @param offices_create_or_patch [OfficesCreateOrPatch] The JSON object that will be posted to the REST API endpoint.
    # @param [Hash] opts the optional parameters
    # @return [GetOffice200Response]
    def create_office(offices_create_or_patch, opts = {})
      data, _status_code, _headers = create_office_with_http_info(offices_create_or_patch, opts)
      data
    end
    ...
    # @param offices_create_or_patch [OfficesCreateOrPatch] The JSON object that will be posted to the REST API endpoint.
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetOffice200Response, Integer, Hash)>] GetOffice200Response data, response status code and response headers
    def create_office_with_http_info(offices_create_or_patch, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OfficesApi.create_office ...'
      end
      # verify the required parameter 'offices_create_or_patch' is set
      if @api_client.config.client_side_validation && offices_create_or_patch.nil?
        fail ArgumentError, "Missing the required parameter 'offices_create_or_patch' when calling OfficesApi.create_office"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(offices_create_or_patch)

      # return_type
      return_type = opts[:debug_return_type] || 'GetOffice200Response'
    ...
    # @param id [String] The ObjectId (unique 12 bytes ID) of record you would like to GET.
    # @param offices_create_or_patch [OfficesCreateOrPatch] The request data.
    # @param [Hash] opts the optional parameters
    # @return [GetOffice200Response]
    def patch_office(id, offices_create_or_patch, opts = {})
      data, _status_code, _headers = patch_office_with_http_info(id, offices_create_or_patch, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetOffice200Response, Integer, Hash)>] GetOffice200Response data, response status code and response headers
    def patch_office_with_http_info(id, offices_create_or_patch, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'offices_create_or_patch' is set
      if @api_client.config.client_side_validation && offices_create_or_patch.nil?
        fail ArgumentError, "Missing the required parameter 'offices_create_or_patch' when calling OfficesApi.patch_office"
      end
      # resource path
      local_var_path = '/offices/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
