...
module CircuitID
  class DomainsApi
    ...
    # @param domains_create_or_patch [DomainsCreateOrPatch] The JSON object that will be posted to the REST API endpoint.
    # @param [Hash] opts the optional parameters
    # @return [GetDomain200Response]
    def create_domain(domains_create_or_patch, opts = {})
      data, _status_code, _headers = create_domain_with_http_info(domains_create_or_patch, opts)
      data
    end
    ...
    def create_domain_with_http_info(domains_create_or_patch, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DomainsApi.create_domain ...'
      end
      # verify the required parameter 'domains_create_or_patch' is set
      if @api_client.config.client_side_validation && domains_create_or_patch.nil?
        fail ArgumentError, "Missing the required parameter 'domains_create_or_patch' when calling DomainsApi.create_domain"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(domains_create_or_patch)
    ...
    def find_domains(opts = {})
      data, _status_code, _headers = find_domains_with_http_info(opts)
      data
    end
    ...
    # @option opts [Array<Object>] :_or Find all records that match any of the given criteria.
    # @option opts [Array<Object>] :_and Find all records that match all of the given criteria.
    # @return [Array<(FindDomains200Response, Integer, Hash)>] FindDomains200Response data, response status code and response headers
    def find_domains_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DomainsApi.find_domains ...'
      end
      # resource path
      local_var_path = '/domains'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'FindDomains200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['jwt']

      new_options = opts.merge(
        :operation => :"DomainsApi.find_domains",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DomainsApi#find_domains\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param id [String] The ObjectId (unique 12 bytes ID) of record you would like to GET.
    # @param domains_create_or_patch [DomainsCreateOrPatch] The request data.
    # @param [Hash] opts the optional parameters
    # @return [GetDomain200Response]
    def patch_domain(id, domains_create_or_patch, opts = {})
      data, _status_code, _headers = patch_domain_with_http_info(id, domains_create_or_patch, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetDomain200Response, Integer, Hash)>] GetDomain200Response data, response status code and response headers
    def patch_domain_with_http_info(id, domains_create_or_patch, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DomainsApi.patch_domain ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling DomainsApi.patch_domain"
      end
      # verify the required parameter 'domains_create_or_patch' is set
      if @api_client.config.client_side_validation && domains_create_or_patch.nil?
        fail ArgumentError, "Missing the required parameter 'domains_create_or_patch' when calling DomainsApi.patch_domain"
      end
      # resource path
      local_var_path = '/domains/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"DomainsApi.patch_domain",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DomainsApi#patch_domain\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [GetDomain200Response]
    def remove_domain(id, opts = {})
      data, _status_code, _headers = remove_domain_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetDomain200Response, Integer, Hash)>] GetDomain200Response data, response status code and response headers
    def remove_domain_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DomainsApi.remove_domain ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling DomainsApi.remove_domain"
      end
      # resource path
      local_var_path = '/domains/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
