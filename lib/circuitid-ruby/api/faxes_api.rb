...
module CircuitID
  class FaxesApi
    ...
    # @param faxes_create_or_patch [FaxesCreateOrPatch] The JSON object that will be posted to the REST API endpoint.
    # @param [Hash] opts the optional parameters
    # @return [GetFax200Response]
    def create_fax(faxes_create_or_patch, opts = {})
      data, _status_code, _headers = create_fax_with_http_info(faxes_create_or_patch, opts)
      data
    end
    ...
    # @param faxes_create_or_patch [FaxesCreateOrPatch] The JSON object that will be posted to the REST API endpoint.
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetFax200Response, Integer, Hash)>] GetFax200Response data, response status code and response headers
    def create_fax_with_http_info(faxes_create_or_patch, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FaxesApi.create_fax ...'
      end
      # verify the required parameter 'faxes_create_or_patch' is set
      if @api_client.config.client_side_validation && faxes_create_or_patch.nil?
        fail ArgumentError, "Missing the required parameter 'faxes_create_or_patch' when calling FaxesApi.create_fax"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(faxes_create_or_patch)

      # return_type
      return_type = opts[:debug_return_type] || 'GetFax200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['jwt']

      new_options = opts.merge(
        :operation => :"FaxesApi.create_fax",
    ...
    # @return [GetFax200Response]
    def get_fax(id, opts = {})
      data, _status_code, _headers = get_fax_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetFax200Response, Integer, Hash)>] GetFax200Response data, response status code and response headers
    def get_fax_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FaxesApi.get_fax ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling FaxesApi.get_fax"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FaxesApi#get_fax\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [GetFax200Response]
    def remove_fax(id, opts = {})
      data, _status_code, _headers = remove_fax_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetFax200Response, Integer, Hash)>] GetFax200Response data, response status code and response headers
    def remove_fax_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FaxesApi.remove_fax ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling FaxesApi.remove_fax"
      end
      # resource path
      local_var_path = '/faxes/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FaxesApi#remove_fax\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
