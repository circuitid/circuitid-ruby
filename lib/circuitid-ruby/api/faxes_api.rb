...
module CircuitID
  class FaxesApi
    ...
    def create_fax(faxes, opts = {})
      data, _status_code, _headers = create_fax_with_http_info(faxes, opts)
      data
    end
    ...
    def create_fax_with_http_info(faxes, opts = {})
      ...
      if @api_client.config.client_side_validation && faxes.nil?
        fail ArgumentError, "Missing the required parameter 'faxes' when calling FaxesApi.create_fax"
      end
      # resource path
