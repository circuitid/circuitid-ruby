...
module CircuitID
  class DNSRecordsApi
    ...
    def find_dns_records(opts = {})
      data, _status_code, _headers = find_dns_records_with_http_info(opts)
      data
    end
    ...
    def find_dns_records_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DNSRecordsApi.find_dns_records ...'
      end
      # resource path
      local_var_path = '/dnsrecords'
      ...
      new_options = opts.merge(
        :operation => :"DNSRecordsApi.find_dns_records",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DNSRecordsApi#find_dns_records\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
