...
module CircuitID
  class GroupsApi
    ...
    # @param groups [Groups] The JSON object that will be posted to the REST API endpoint.
    # @param [Hash] opts the optional parameters
    # @return [GetGroup200Response]
    def create_group(groups, opts = {})
      data, _status_code, _headers = create_group_with_http_info(groups, opts)
      data
    end
    ...
    def create_group_with_http_info(groups, opts = {})
      ...
      if @api_client.config.client_side_validation && groups.nil?
        fail ArgumentError, "Missing the required parameter 'groups' when calling GroupsApi.create_group"
      end
      # resource path
    ...
    # @param id [String] The ObjectId (unique 12 bytes ID) of record you would like to GET.
    # @param groups [Groups] The request data.
    # @param [Hash] opts the optional parameters
    # @return [GetGroup200Response]
    def patch_group(id, groups, opts = {})
      data, _status_code, _headers = patch_group_with_http_info(id, groups, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetGroup200Response, Integer, Hash)>] GetGroup200Response data, response status code and response headers
    def patch_group_with_http_info(id, groups, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'groups' is set
      if @api_client.config.client_side_validation && groups.nil?
        fail ArgumentError, "Missing the required parameter 'groups' when calling GroupsApi.patch_group"
      end
      # resource path
      local_var_path = '/groups/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
