...
module CircuitID
  class LicensesApi
    ...
    # @param licenses [Licenses] The JSON object that will be posted to the REST API endpoint.
    # @param [Hash] opts the optional parameters
    # @return [Object]
    def create_license(licenses, opts = {})
      data, _status_code, _headers = create_license_with_http_info(licenses, opts)
      data
    end
    ...
    def create_license_with_http_info(licenses, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LicensesApi.create_license ...'
      end
      # verify the required parameter 'licenses' is set
      if @api_client.config.client_side_validation && licenses.nil?
        fail ArgumentError, "Missing the required parameter 'licenses' when calling LicensesApi.create_license"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(licenses)
    ...
    # @param id [Object] The ObjectId (unique 12 bytes ID) of record you would like to GET.
    # @param licenses [Licenses] The request data.
    # @param [Hash] opts the optional parameters
    # @return [Object]
    def patch_license(id, licenses, opts = {})
      data, _status_code, _headers = patch_license_with_http_info(id, licenses, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Object, Integer, Hash)>] Object data, response status code and response headers
    def patch_license_with_http_info(id, licenses, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'licenses' is set
      if @api_client.config.client_side_validation && licenses.nil?
        fail ArgumentError, "Missing the required parameter 'licenses' when calling LicensesApi.patch_license"
      end
      # resource path
      local_var_path = '/licenses/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
