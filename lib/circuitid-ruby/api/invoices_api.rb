...
module CircuitID
  class InvoicesApi
    ...
    def find_invoices(opts = {})
      data, _status_code, _headers = find_invoices_with_http_info(opts)
      data
    end
    ...
    # @option opts [Object] :_or Find all records that match any of the given criteria.
    # @option opts [Object] :_and Find all records that match all of the given criteria.
    # @return [Array<(FindInvoices200Response, Integer, Hash)>] FindInvoices200Response data, response status code and response headers
    def find_invoices_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: InvoicesApi.find_invoices ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'FindInvoices200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['jwt']

      new_options = opts.merge(
        :operation => :"InvoicesApi.find_invoices",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: InvoicesApi#find_invoices\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
