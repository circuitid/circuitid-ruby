...
module CircuitID
  class GetFax200Response
    ...
    def hash
      [caller_id_number, caller_destination, pages, status_code, transfered_pages, status, error, type, order, file, contact, number, fax_account, retries, invoice, sender_email, sender_name, created_by_user_id, updated_by_user_id, created_at, updated_at].hash
    end
