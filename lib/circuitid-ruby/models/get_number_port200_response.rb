...
module CircuitID
  class GetNumberPort200Response
    ...
    def hash
      [name, type, type_of_service, authorized_person, desired_due_date, account_number, account_phone_number, office, e911, invoice, status, destination_type, destination, ref, call_forwarding_destination, created_by_user_id, updated_by_user_id, created_at, updated_at].hash
    end
