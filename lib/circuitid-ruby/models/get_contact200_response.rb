...
module CircuitID
  class GetContact200Response
    ...
    def hash
      [email, first, last, mobile_phone, business_phone, fax_phone, extension, job_title, department, avatar, created_by_user_id, updated_by_user_id, created_at, updated_at].hash
    end
