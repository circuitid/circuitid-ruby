...
module CircuitID
  class GetPhoneInboundRuleAction200Response
    attr_accessor :name

    # ObjectId (unique 12 bytes ID)
    attr_accessor :phoneinboundrule
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CircuitID::GetPhoneInboundRuleAction200Response` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CircuitID::GetPhoneInboundRuleAction200Response`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'phoneinboundrule')
        self.phoneinboundrule = attributes[:'phoneinboundrule']
      end
    ...
    def list_invalid_properties
      ...
      if @phoneinboundrule.nil?
        invalid_properties.push('invalid value for "phoneinboundrule", phoneinboundrule cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @phoneinboundrule.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          name == o.name &&
          phoneinboundrule == o.phoneinboundrule &&
    ...
    def hash
      [name, phoneinboundrule, timeschedule, timeout, status, priority, destination_type, destination, call_forwarding_destination, _id, created_by_user_id, updated_by_user_id, created_at, updated_at].hash
    end
