...
module CircuitID
  class GetPhoneInboundRuleAction200Response
    ...
    def hash
      [name, phoneinboundrule, timeschedule, timeout, status, priority, destination_type, destination, ref, call_forwarding_destination, created_by_user_id, updated_by_user_id, created_at, updated_at].hash
    end
