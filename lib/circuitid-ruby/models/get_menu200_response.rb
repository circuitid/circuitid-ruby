...
module CircuitID
  class GetMenu200Response
    ...
    def hash
      [name, max_extension_length, speech_recognition, directory, greeting_type, greeting_tts, menu_voice, exit_sound, transfer_announcement, max_failures, max_timeouts, timeout, touch_tone_terminators, timeschedule, destination_type, destination, ref, call_forwarding_destination, created_by_user_id, updated_by_user_id, created_at, updated_at].hash
    end
