...
module CircuitID
  class GetHoliday200Response
    ...
    def hash
      [name, object, object_ref, date_time_ranges, status, destination_type, destination, ref, call_forwarding_destination, created_by_user_id, updated_by_user_id, created_at, updated_at].hash
    end
