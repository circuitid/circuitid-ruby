...
module CircuitID
  class GetMessageCampaign200Response
    attr_accessor :name
    ...
    def self.openapi_types
      {
        ...
        :'brand_id' => :'String',
        :'order' => :'String',
        :'subscriber_optin' => :'Integer',
        :'subscriber_optout' => :'Integer',
        :'subscriber_help' => :'Integer',
        :'number_pool' => :'Integer',
        :'direct_lending' => :'Integer',
        :'embedded_link' => :'Integer',
        :'embedded_phone' => :'Integer',
        :'affiliate_marketing' => :'Integer',
        :'age_gated' => :'Integer',
        :'mnos' => :'Object',
        :'reference_id' => :'String',
        :'use_case' => :'String',
        :'sub_use_cases' => :'Array<Object>',
        :'sample1' => :'String',
        :'sample2' => :'String',
        :'sample3' => :'String',
        :'sample4' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CircuitID::GetMessageCampaign200Response` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CircuitID::GetMessageCampaign200Response`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'sub_use_cases')
        if (value = attributes[:'sub_use_cases']).is_a?(Array)
          self.sub_use_cases = value
        end
      end
    ...
    def valid?
      ...
      subscriber_optin_validator = EnumAttributeValidator.new('Integer', [1, 0])
      return false unless subscriber_optin_validator.valid?(@subscriber_optin)
      subscriber_optout_validator = EnumAttributeValidator.new('Integer', [1, 0])
      return false unless subscriber_optout_validator.valid?(@subscriber_optout)
      subscriber_help_validator = EnumAttributeValidator.new('Integer', [1, 0])
      return false unless subscriber_help_validator.valid?(@subscriber_help)
      number_pool_validator = EnumAttributeValidator.new('Integer', [1, 0])
      return false unless number_pool_validator.valid?(@number_pool)
      direct_lending_validator = EnumAttributeValidator.new('Integer', [1, 0])
      return false unless direct_lending_validator.valid?(@direct_lending)
      embedded_link_validator = EnumAttributeValidator.new('Integer', [1, 0])
      return false unless embedded_link_validator.valid?(@embedded_link)
      embedded_phone_validator = EnumAttributeValidator.new('Integer', [1, 0])
      return false unless embedded_phone_validator.valid?(@embedded_phone)
      affiliate_marketing_validator = EnumAttributeValidator.new('Integer', [1, 0])
      return false unless affiliate_marketing_validator.valid?(@affiliate_marketing)
      age_gated_validator = EnumAttributeValidator.new('Integer', [1, 0])
    ...
    def hash
      [name, campaign_id, brand_id, order, subscriber_optin, subscriber_optout, subscriber_help, number_pool, direct_lending, embedded_link, embedded_phone, affiliate_marketing, age_gated, mnos, reference_id, use_case, sub_use_cases, sample1, sample2, sample3, sample4, sample5, _id, created_by_user_id, updated_by_user_id, created_at, updated_at].hash
    end
