...
module CircuitID
  class GetMessageCampaign200Response
    ...
    def hash
      [name, campaign_id, brand_id, order, subscriber_optin, subscriber_optout, subscriber_help, number_pool, direct_lending, embedded_link, embedded_phone, affiliate_marketing, age_gated, mnos, reference_id, use_case, sub_use_cases, sample1, sample2, sample3, sample4, sample5, created_by_user_id, updated_by_user_id, created_at, updated_at].hash
    end
