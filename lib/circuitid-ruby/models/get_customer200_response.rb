  ...
  class GetCustomer200Response
    ...
    def self.openapi_types
      {
        ...
        :'call_forwarding_call_limit' => :'Integer',
        :'support_user_id' => :'String',
        :'automatic_refill_amount' => :'Integer',
        :'low_balance_alert_amount' => :'Integer',
        :'low_balance_alert_at' => :'Time',
        :'low_balance_alert_count' => :'Integer',
        :'last_automatic_refill_invoice' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'call_forwarding_call_limit')
        ...
        self.call_forwarding_call_limit = 10
      end
      ...
      if attributes.key?(:'low_balance_alert_count')
        ...
        self.low_balance_alert_count = 0
      end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["active", "suspended", "terminated", "fraud"])
      ...
      call_debug_validator = EnumAttributeValidator.new('Integer', [1, 0])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["active", "suspended", "terminated", "fraud"])
