...
module CircuitID
  class GetDeveloperApp200Response
    ...
    def hash
      [name, description, type, visibility, require_id, is_free, fee_description, integration_type, services, events, user, webhook_url, terms_of_service_url, privacy_policy_url, permissions, webhook_auth_type, webhook_username, webhook_password, webhook_token_name, webhook_token, _id, created_by_user_id, updated_by_user_id, created_at, updated_at].hash
    end
