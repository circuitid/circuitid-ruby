...
module CircuitID
  class GetNumber200Response
    ...
    def self.openapi_types
      {
        ...
        :'sms' => :'Integer',
        :'mms' => :'Integer',
        :'change_region_order_id' => :'String',
        :'change_region_order_date' => :'Time',
        :'directory_listing' => :'String',
        :'directory_listing_order_id' => :'String',
        :'directory_listing_order_date' => :'Time',
        :'caller_name' => :'String',
        :'caller_name_order_id' => :'String',
        :'caller_name_order_date' => :'Time',
        :'e911' => :'String',
        :'e911_order_id' => :'String',
        :'e911_order_date' => :'Time',
        :'message_campaign' => :'String',
        :'message_class' => :'String',
        :'message_type' => :'String',
        :'message_campaign_order_id' => :'String',
        :'message_campaign_order_date' => :'Time',
    ...
    def hash
      [in_use, name, country_code, amount, per_minute_rate, provider, original_provider, provider_order_id, fax, voice, status, sms, mms, change_region_order_id, change_region_order_date, directory_listing, directory_listing_order_id, directory_listing_order_date, caller_name, caller_name_order_id, caller_name_order_date, e911, e911_order_id, e911_order_date, message_campaign, message_class, message_type, message_campaign_order_id, message_campaign_order_date, e911_supported, caller_name_supported, directory_listing_supported, messaging_supported, destination_type, destination, ref, call_forwarding_destination, created_by_user_id, updated_by_user_id, created_at, updated_at].hash
    end
