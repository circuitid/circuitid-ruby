...
module CircuitID
  class GetTimeSchedule200Response
    attr_accessor :name
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CircuitID::GetTimeSchedule200Response` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CircuitID::GetTimeSchedule200Response`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'sunday')
        if (value = attributes[:'sunday']).is_a?(Hash)
          self.sunday = value
        end
      end

      if attributes.key?(:'monday')
        if (value = attributes[:'monday']).is_a?(Hash)
          self.monday = value
        end
      end

      if attributes.key?(:'tuesday')
        if (value = attributes[:'tuesday']).is_a?(Hash)
          self.tuesday = value
        end
      end

      if attributes.key?(:'wednesday')
        if (value = attributes[:'wednesday']).is_a?(Hash)
          self.wednesday = value
        end
      end

      if attributes.key?(:'thursday')
        if (value = attributes[:'thursday']).is_a?(Hash)
          self.thursday = value
        end
      end

      if attributes.key?(:'friday')
        if (value = attributes[:'friday']).is_a?(Hash)
          self.friday = value
        end
      end

      if attributes.key?(:'saturday')
        if (value = attributes[:'saturday']).is_a?(Hash)
          self.saturday = value
        end
      end
    ...
    def hash
      [name, timezone, sunday, monday, tuesday, wednesday, thursday, friday, saturday, _id, created_by_user_id, updated_by_user_id, created_at, updated_at].hash
    end
