...
module CircuitID
  class GetServer200Response
    ...
    def hash
      [name, host, port, caller_id, type, inbound_sip_trunking_order, outbound_sip_trunking_order, no_instant_ring_back, bypass_media, disable_rtp_auto_adjust, _id, created_by_user_id, updated_by_user_id, created_at, updated_at].hash
    end
