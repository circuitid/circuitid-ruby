...
module CircuitID
  class GetOffice200Response
    ...
    def hash
      [name, street_number, street_name, pre_direction, street_suffix, city, state, zip, zip_code, address2, country, providers, region, created_by_user_id, updated_by_user_id, created_at, updated_at].hash
    end
