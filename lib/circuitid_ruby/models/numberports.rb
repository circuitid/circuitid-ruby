  ...
  class Numberports
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CircuitIDAPIClient::Numberports` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CircuitIDAPIClient::Numberports`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('Object', ["port in", "port out"])
      return false unless type_validator.valid?(@type)
      type_of_service_validator = EnumAttributeValidator.new('Object', ["business", "residence"])
      ...
      e911_validator = EnumAttributeValidator.new('Object', ["1", "0"])
      return false unless e911_validator.valid?(@e911)
      status_validator = EnumAttributeValidator.new('Object', ["processing", "failed", "error", "completed"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('Object', ["port in", "port out"])
    ...
    def type_of_service=(type_of_service)
      validator = EnumAttributeValidator.new('Object', ["business", "residence"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('Object', ["processing", "failed", "error", "completed"])
