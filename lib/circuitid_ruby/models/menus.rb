  ...
  class Menus
    ...
    def self.openapi_types
      {
        ...
        :'menu_voice' => :'Object',
        :'exit_sound' => :'Object',
        :'transfer_announcement' => :'Object',
        :'max_failures' => :'Object',
        :'max_timeouts' => :'Object',
        :'timeout' => :'Object',
        :'touch_tone_terminators' => :'Object',
        :'timeschedule' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CircuitIDAPIClient::Menus` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CircuitIDAPIClient::Menus`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      speech_recognition_validator = EnumAttributeValidator.new('Object', ["1", "0"])
      return false unless speech_recognition_validator.valid?(@speech_recognition)
      greeting_type_validator = EnumAttributeValidator.new('Object', ["tts", "mp3"])
      return false unless greeting_type_validator.valid?(@greeting_type)
      exit_sound_validator = EnumAttributeValidator.new('Object', ["default", "mp3"])
      return false unless exit_sound_validator.valid?(@exit_sound)
      transfer_announcement_validator = EnumAttributeValidator.new('Object', ["default", "mp3", "none"])
      return false unless transfer_announcement_validator.valid?(@transfer_announcement)
      touch_tone_terminators_validator = EnumAttributeValidator.new('Object', ["1", "0"])
    ...
    def greeting_type=(greeting_type)
      validator = EnumAttributeValidator.new('Object', ["tts", "mp3"])
    ...
    def exit_sound=(exit_sound)
      validator = EnumAttributeValidator.new('Object', ["default", "mp3"])
    ...
    def transfer_announcement=(transfer_announcement)
      validator = EnumAttributeValidator.new('Object', ["default", "mp3", "none"])
